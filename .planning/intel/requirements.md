...
- [REQ-029] Data portability (GDPR Article 20): GET /v1/account/export endpoint returns a JSON bundle of all children, events, preferences, and consent records for the requesting user's org. Deferred to v2 but must not be forgotten. (source: docs/05-privacy.md)
